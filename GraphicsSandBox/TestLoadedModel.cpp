...
TestLoadedModel::TestLoadedModel(Graphics& gfx, std::mt19937& rng,
	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	if (!IsStaticInitialized())
	{
		...
		Assimp::Importer imp;
		auto pModel = imp.ReadFile("Resources\\Models\\suzanne.obj",
...
TestLoadedModel::TestLoadedModel(Graphics& gfx,
	DirectX::XMFLOAT3 material,
	float scale)
	:
	TestObject(gfx)
